...
function va(a,b){a.j={Ta:b,Za:!0};a.h=a.m||a.o}
...
function ya(a){a.m=0;var b=a.j.Ta;a.j=null;return b}
function za(a){a.H=[a.j];a.m=0;a.o=0}
function Ba(a){var b=a.H.splice(0)[0];(b=a.j=a.j||b)?b.Za?a.h=a.m||a.o:void 0!=b.s&&a.o<b.s?(a.h=b.s,a.j=null):a.h=a.o:a.h=0}
...
function Fa(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.u=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,va(a.h,c)}a.h.u=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.Za)throw b.Ta;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
var h=this,k=!1;return{resolve:g(this.Ha),reject:g(this.o)}};
b.prototype.Ha=function(g){if(g===this)this.o(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.jb(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.Ga(g):this.m(g)}};
b.prototype.Ga=function(g){var h=void 0;try{h=g.then}catch(k){this.o(k);return}"function"==typeof h?this.kb(h,g):this.m(g)};
b.prototype.o=function(g){this.C(2,g)};
b.prototype.m=function(g){this.C(1,g)};
b.prototype.C=function(g,h){if(0!=this.h)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.h);this.h=g;this.j=h;2===this.h&&this.Ia();this.H()};
b.prototype.Ia=function(){var g=this;e(function(){if(g.V()){var h=fa.console;"undefined"!==typeof h&&h.error(g.j)}},1)};
...
var f=new c;b.prototype.jb=function(g){var h=this.l();g.va(h.resolve,h.reject)};
...
var r=[],q=0;do r.push(void 0),q++,d(k.value).va(n(r.length-1),m),k=h.next();while(!k.done)})};
return b});
...
c.prototype=b.prototype;a.P=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.dc=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
kc&&(jc=kc?kc[1]:"");if(dc){var lc=hc();if(null!=lc&&lc>parseFloat(jc)){ic=String(lc);break a}}ic=jc}var mc=ic,nc;if(z.document&&dc){var oc=hc();nc=oc?oc:parseInt(mc,10)||void 0}else nc=void 0;var pc=nc;var qc=ac()||F("iPod"),rc=F("iPad");!F("Android")||Lb();Lb();var sc=F("Safari")&&!(Lb()||F("Coast")||F("Opera")||F("Edge")||F("Edg/")||F("OPR")||F("Firefox")||F("FxiOS")||F("Silk")||F("Android"))&&!(ac()||F("iPad")||F("iPod"));var tc={},vc=null;function wc(a,b){Oa(a);void 0===b&&(b=0);xc();b=tc[b];for(var c=Array(Math.floor(a.length/3)),d=b[64]||"",e=0,f=0;e<a.length-2;e+=3){var g=a[e],h=a[e+1],k=a[e+2],l=b[g>>2];g=b[(g&3)<<4|h>>4];h=b[(h&15)<<2|k>>6];k=b[k&63];c[f++]=""+l+g+h+k}l=0;k=d;switch(a.length-e){case 2:l=a[e+1],k=b[(l&15)<<2]||d;case 1:a=a[e],c[f]=""+b[a>>2]+b[(a&3)<<4|l>>4]+k+d}return c.join("")}
...
Fc.prototype.sizeBytes=function(){Ec();var a=this.oa;null==a||Bc(a)||("string"===typeof a?a=yc(a):(La(a),a=null));return(a=null==a?a:this.oa=a)?a.length:0};var Gc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol():void 0;function Hc(a,b){if(Gc)return a[Gc]|=b;if(void 0!==a.N)return a.N|=b;Object.defineProperties(a,{N:{value:b,configurable:!0,writable:!0,enumerable:!1}});return b}
...
;var ad;function bd(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a)if(Array.isArray(a)){if(0!==(G(a)&128))return a=Array.prototype.slice.call(a),Yc(a),a}else{if(Bc(a))return wc(a);if(a instanceof Fc){var b=a.oa;return null==b?"":"string"===typeof b?b:a.oa=wc(b)}}}return a}
...
function ed(a){return a.Aa===Sc?a.toJSON():bd(a)}
function fd(a){if(!a)return a;if("object"===typeof a){if(Bc(a))return new Uint8Array(a);if(a.Aa===Sc)return a.clone()}return a}
...
function od(a,b,c){var d=void 0===d?!1:d;var e=id(a,c,d);var f=!1;var g=null==e||"object"!==typeof e||(f=Array.isArray(e))||e.Aa!==Sc?f?new b(e):void 0:e;g!==e&&null!=g&&(jd(a,c,g,d),Hc(g.v,G(a.v)&-33));b=kd(g,a);if(null==b)return b;Lc(a.v)||(e=pd(b),e!==b&&(b=e,jd(a,c,b,d)));return kd(b,a)}
...
;function wd(a,b,c){c=void 0===c?Rc:c;if(null!=a){if(Ac&&a instanceof Uint8Array)return a.length?new Fc(new Uint8Array(a)):Dc||(Dc=new Fc(null));if(Array.isArray(a)){var d=G(a);if(d&2)return a;if(b&&!(d&32)&&(d&16||0===d))return Jc(a,d|2),a;a=dd(a,wd,c,!0);b=G(a);b&4&&b&2&&Object.freeze(a);return a}return a.Aa===Sc?xd(a):a}}
...
L.prototype.Aa=Sc;L.prototype.toString=function(){return this.v.toString()};
function Cd(a,b){return bd(b)}
function Dd(a,b){b.ja&&(a.ja=b.ja.slice());var c=b.h;if(c){b=b.i;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=e[0].constructor,l=Lc(h.v);k=qd(h,k,g,f,l,l);f=ld(h,g,3,f,l);if(!l&&f&&!(G(f)&8)){for(l=0;l<k.length;l++)g=k[l],h=pd(g),g!==h&&(k[l]=h,f[l]=k[l].v);Hc(f,8)}for(l=0;l<Math.min(k.length,e.length);l++)Dd(k[l],e[l])}}else throw Error("unexpected object: type: "+La(e)+": "+e);}}}}
...
p.za=function(){return!(this.width*this.height)};
...
function Td(a,b){b=void 0===b?Sd:b;for(var c=0;c<b.length;++c){var d=b[c];if(d instanceof Qd&&d.Ab(a))return new Hb(a,Ib)}}
...
return a}
var Yd={Kb:"allow-forms",Lb:"allow-modals",Mb:"allow-orientation-lock",Nb:"allow-pointer-lock",Ob:"allow-popups",Pb:"allow-popups-to-escape-sandbox",Qb:"allow-presentation",Rb:"allow-same-origin",Sb:"allow-scripts",Tb:"allow-top-navigation",Ub:"allow-top-navigation-by-user-activation"},$d=$a(function(){return Zd()});
...
function ie(a){var b=fe();b.update(a);return b.pb().toLowerCase()}
;var je={};function ke(a){this.h=a||{cookie:""}}
p=ke.prototype;p.isEnabled=function(){if(!z.navigator.cookieEnabled)return!1;if(!this.za())return!0;this.set("TESTCOOKIESENABLED","1",{Ka:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
p.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.lc;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ka}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
p.remove=function(a,b,c){var d=void 0!==this.get(a);this.set(a,"",{Ka:0,path:b,domain:c});return d};
p.za=function(){return!this.h.cookie};
...
se.prototype.preventDefault=function(){se.P.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var ue="closure_listenable_"+(1E6*Math.random()|0);var ve=0;function we(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.ya=e;this.key=++ve;this.ka=this.ta=!1}
function xe(a){a.ka=!0;a.listener=null;a.proxy=null;a.src=null;a.ya=null}
;function ye(a){this.src=a;this.listeners={};this.h=0}
ye.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.h++);var g=ze(a,b,d,e);-1<g?(b=a[g],c||(b.ta=!1)):(b=new we(b,this.src,f,!!d,e),b.ta=c,a.push(b));return b};
...
function ze(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ka&&f.listener==b&&f.capture==!!c&&f.ya==d)return e}return-1}
...
function Ne(a){if("number"!==typeof a&&a&&!a.ka){var b=a.src;if(b&&b[ue])Ae(b.h,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ke(c),d):b.addListener&&b.removeListener&&b.removeListener(d);De--;(c=Ie(b))?(Ae(c,a),0==c.h&&(c.src=null,b[Be]=null)):xe(a)}}}
function Ke(a){return a in Ce?Ce[a]:Ce[a]="on"+a}
function Le(a,b){if(a.ka)a=!0;else{b=new se(b,this);var c=a.listener,d=a.ya||a.src;a.ta&&Ne(a);a=c.call(d,b)}return a}
...
function Re(a,b,c,d){b=a.h.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ka&&g.capture==c){var h=g.listener,k=g.ya||g.src;g.ta&&Ae(a.h,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
p.za=function(){return 0==this.size};
...
function Jg(a,b,c){var d=Kg;if(a=d.i[a]){var e=d.h;(a=a.find(function(f){return e[f+1]==b&&e[f+2]==c}))&&d.na(a)}}
p.na=function(a){var b=this.h[a];if(b){var c=this.i[b];0!=this.m?(this.l.push(a),this.h[a+1]=function(){}):(c&&eb(c,a),delete this.h[a],delete this.h[a+1],delete this.h[a+2])}return!!b};
p.ea=function(a,b){var c=this.i[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.C)for(e=0;e<c.length;e++){var g=c[e];Lg(this.h[g+1],this.h[g+2],d)}else{this.m++;try{for(e=0,f=c.length;e<f&&!this.j;e++)g=c[e],this.h[g+1].apply(this.h[g+2],d)}finally{if(this.m--,0<this.l.length&&0==this.m)for(;c=this.l.pop();)this.na(c)}}return 0!=e}return!1};
function Lg(a,b,c){Bf(function(){a.apply(b,c)})}
p.clear=function(a){if(a){var b=this.i[a];b&&(b.forEach(this.na,this),delete this.i[a])}else this.h.length=0,this.i={}};
...
v(sh,L);var th=[12];var uh={Zb:"WEB_DISPLAY_MODE_UNKNOWN",Vb:"WEB_DISPLAY_MODE_BROWSER",Xb:"WEB_DISPLAY_MODE_MINIMAL_UI",Yb:"WEB_DISPLAY_MODE_STANDALONE",Wb:"WEB_DISPLAY_MODE_FULLSCREEN"};function vh(a){L.call(this,a,-1,wh)}
...
;var bi=0;B("ytDomDomGetNextId",C("ytDomDomGetNextId")||function(){return++bi});var ci={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
function di(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in ci||(this[b]=a[b]);var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;if(d)try{d=d.nodeName?d:null}catch(e){d=null}else"mouseover"==
this.type?d=a.fromElement:"mouseout"==this.type&&(d=a.toElement);this.relatedTarget=d;this.clientX=void 0!=a.clientX?a.clientX:a.pageX;this.clientY=void 0!=a.clientY?a.clientY:a.pageY;this.keyCode=a.keyCode?a.keyCode:a.which;this.charCode=a.charCode||("keypress"==this.type?this.keyCode:0);this.altKey=a.altKey;this.ctrlKey=a.ctrlKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.h=a.pageX;this.i=a.pageY}}catch(e){}}
function ei(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.h=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.i=a.clientY+b}}
di.prototype.preventDefault=function(){this.event&&(this.event.returnValue=!1,this.event.preventDefault&&this.event.preventDefault())};
di.prototype.stopPropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopPropagation&&this.event.stopPropagation())};
di.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var kb=z.ytEventsEventsListeners||{};B("ytEventsEventsListeners",kb);var fi=z.ytEventsEventsCounter||{count:0};B("ytEventsEventsCounter",fi);
...
function hi(a){a&&("string"==typeof a&&(a=[a]),E(a,function(b){if(b in kb){var c=kb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?ii()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete kb[b]}}))}
var ii=$a(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function ji(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=gi(a,b,c,d);if(e)return e;e=++fi.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new di(h);if(!Id(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new di(h);
h.currentTarget=a;return c.call(a,h)};
g=Zh(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),ii()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);kb[e]=[a,b,c,g,d];return e}
;function ki(a,b){"function"===typeof a&&(a=Zh(a));return window.setTimeout(a,b)}
function li(a,b){"function"===typeof a&&(a=Zh(a));return window.setInterval(a,b)}
;var mi=/^[\w.]*$/,ni={q:!0,search_query:!0};function oi(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=pi(f[0]||""),h=pi(f[1]||"");g in c?Array.isArray(c[g])?hb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(n){var k=n,l=f[0],m=String(oi);k.args=[{key:l,value:f[1],query:a,method:qi==m?"unchanged":m}];ni.hasOwnProperty(l)||ai(k)}}return c}
var qi=String(oi);function ri(a){var b=[];ib(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];E(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function si(a){"?"==a.charAt(0)&&(a=a.substr(1));return oi(a,"&")}
function ti(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=si(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);b=a;a=Tb(e);a?(c=b.indexOf("#"),0>c&&(c=b.length),f=b.indexOf("?"),0>f||f>c?(f=c,e=""):e=b.substring(f+1,c),b=[b.slice(0,f),e,b.slice(c)],c=b[1],b[1]=a?c?c+"&"+a:a:c,a=b[0]+(b[1]?"?"+b[1]:"")+b[2]):a=b;return a+d}
function ui(a){if(!b)var b=window.location.href;var c=a.match(Ob)[1]||null,d=Qb(a);c&&d?(a=a.match(Ob),b=b.match(Ob),a=a[3]==b[3]&&a[1]==b[1]&&a[4]==b[4]):a=d?Qb(b)==d&&(Number(b.match(Ob)[4]||null)||null)==(Number(a.match(Ob)[4]||null)||null):!0;return a}
function pi(a){return a&&a.match(mi)?a:decodeURIComponent(a.replace(/\+/g," "))}
;function R(a){a=vi(a);return"string"===typeof a&&"false"===a?!1:!!a}
function wi(a,b){a=vi(a);return void 0===a&&void 0!==b?b:Number(a||0)}
function vi(a){var b=P("EXPERIMENTS_FORCED_FLAGS",{})||{};return void 0!==b[a]?b[a]:P("EXPERIMENT_FLAGS",{})[a]}
function xi(){for(var a=[],b=P("EXPERIMENTS_FORCED_FLAGS",{}),c=u(Object.keys(b)),d=c.next();!d.done;d=c.next())d=d.value,a.push({key:d,value:String(b[d])});c=P("EXPERIMENT_FLAGS",{});var e=u(Object.keys(c));for(d=e.next();!d.done;d=e.next())d=d.value,d.startsWith("force_")&&void 0===b[d]&&a.push({key:d,value:String(c[d])});return a}
...
B("yt.ads_.signals_.getAdSignalsString",function(a){return ri(yi(a))});Date.now();var Ai="XMLHttpRequest"in z?function(){return new XMLHttpRequest}:null;
...
d=b.timeout||0;if(b.onTimeout&&0<d){var g=b.onTimeout;var h=ki(function(){e||(e=!0,f.abort(),window.clearTimeout(h),g.call(b.context||z,f))},d)}}
function Ii(a,b){b.includeDomain&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=P("XSRF_FIELD_NAME");if(b=b.urlParams)b[c]&&delete b[c],a=ti(a,b||{},!0);return a}
function Ji(a,b){var c=P("XSRF_FIELD_NAME"),d=P("XSRF_TOKEN"),e=b.postBody||"",f=b.postParams,g=P("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Qb(a)&&!b.withCredentials&&Qb(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);(R("ajax_parse_query_data_only_when_filled")&&f&&0<Object.keys(f).length||f)&&"string"===typeof e&&(e=si(e),ob(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?
...
function Xi(a,b,c){void 0!==c&&Number.isNaN(Number(c))&&(c=void 0);var d=C("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):ki(a,c||0)}
...
ej.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Vf(b))}catch(f){return}else e=escape(b);b=this.i;le.set(""+a,e,{Ka:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
function Qk(a,b){b=void 0===b?{}:b;var c,d,e,f;return x(function(g){if(1==g.h)return wa(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.lb)&&c.addEventListener("blocked",function(){e()}),w(g,Hj(c),4);
...
function Vk(a){function b(){var f,g,h,k,l,m,n,r,q,y;return x(function(A){switch(A.h){case 1:return g=null!=(f=Error().stack)?f:"",wa(A,2),w(A,a.j(a.name,a.options.version,d),4);case 4:h=A.i;for(var H=a.options,K=[],M=u(Object.keys(H.da)),O=M.next();!O.done;O=M.next()){O=O.value;var pb=H.da[O],uc=void 0===pb.Db?Number.MAX_VALUE:pb.Db;!(h.h.version>=pb.ga)||h.h.version>=uc||h.h.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){A.s(5);break}l=Object.keys(a.options.da);m=h.objectStoreNames();
if(a.m<wi("ytidb_reopen_db_retries",0))return a.m++,h.close(),jj(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());if(!(a.o<wi("ytidb_remake_db_retries",1))){A.s(6);break}a.o++;if(!R("ytidb_remake_db_enable_backoff_delay")){A.s(7);break}return w(A,Rk(a.i),8);case 8:a.i*=2;case 7:return w(A,a.delete(),9);case 9:return jj(new T("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());
...
if(!a.l)throw Tk(a);if(a.h)return a.h;var d={mb:function(f){f.close()},
closed:c,Fb:c,upgrade:a.options.upgrade};var e=b();a.h=e;return a.h}
...
ol.prototype.j=function(a,b,c){c=void 0===c?{}:c;return(this.options.Fa?jl:il)(a,b,Object.assign({},c))};
ol.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Fa?nl:kl)(this.name,a)};
function ql(a,b){return pl(a,b)}
;var rl={},sl=ql("ytGcfConfig",{da:(rl.coldConfigStore={ga:1},rl.hotConfigStore={ga:1},rl),Fa:!1,upgrade:function(a,b){b(1)&&(Tj(Mj(a,"hotConfigStore",{keyPath:"key",autoIncrement:!0}),"hotTimestampIndex","timestamp"),Tj(Mj(a,"coldConfigStore",{keyPath:"key",autoIncrement:!0}),"coldTimestampIndex","timestamp"))},
...
function Cl(){return{ub:P("INNERTUBE_API_KEY"),vb:P("INNERTUBE_API_VERSION"),Ja:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Va:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),wb:P("INNERTUBE_CONTEXT_CLIENT_NAME",1),Wa:P("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ya:P("INNERTUBE_CONTEXT_HL"),Xa:P("INNERTUBE_CONTEXT_GL"),xb:P("INNERTUBE_HOST_OVERRIDE")||"",zb:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),yb:!!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",!1),appInstallData:P("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Dl(a){var b={client:{hl:a.Ya,gl:a.Xa,clientName:a.Va,clientVersion:a.Wa,configInfo:a.Ja}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=z.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=P("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=xi();0<c.length&&(b.request={internalExperimentFlags:c});El(a,void 0,b);R("enable_third_party_info")&&Fl(void 0,b);Gl(void 0,b);Hl(a,void 0,b);Il(void 0,b);R("start_sending_config_hash")&&Jl(void 0,
b);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(b.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});a=Object;c=a.assign;for(var d=b.client,e={},f=u(Object.entries(si(P("DEVICE","")))),g=f.next();!g.done;g=f.next()){var h=u(g.value);g=h.next().value;h=h.next().value;"cbrand"===g?e.deviceMake=h:"cmodel"===g?e.deviceModel=h:"cbr"===g?e.browserName=h:"cbrver"===g?e.browserVersion=h:"cos"===g?e.osName=h:"cosver"===g?e.osVersion=h:"cplatform"===g&&(e.platform=h)}b.client=c.call(a,d,e);return b}
function Kl(a){var b=new sh,c=new jh;I(c,1,a.Ya);I(c,2,a.Xa);I(c,16,a.wb);I(c,17,a.Wa);if(a.Ja){var d=a.Ja,e=new fh;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);J(c,fh,62,e)}(d=z.devicePixelRatio)&&1!=d&&I(c,65,d);d=P("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=xi();if(0<d.length){e=new lh;for(var f=0;f<d.length;f++){var g=new dh;I(g,1,d[f].key);md(g,2,eh,d[f].value);td(e,15,dh,g)}J(b,
lh,5,e)}El(a,c);R("enable_third_party_info")&&Fl(b);Gl(c);Hl(a,c);Il(c);R("start_sending_config_hash")&&Jl(c);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(a=new qh,I(a,3,P("DELEGATED_SESSION_ID")));a=u(Object.entries(si(P("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=u(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?I(c,12,e):"cmodel"===d?I(c,13,e):"cbr"===d?I(c,87,e):"cbrver"===d?I(c,88,e):"cos"===d?I(c,18,e):"cosver"===d?I(c,19,e):"cplatform"===d&&I(c,42,e);J(b,jh,1,c);
return b}
function El(a,b,c){a=a.Va;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=od(b,gh,96)||new gh;var d=Pi();d=Object.keys(uh).indexOf(d);d=-1===d?null:d;null!==d&&I(c,3,d);J(b,gh,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Pi())}
...
function Ll(a,b,c){c=void 0===c?{}:c;var d={};P("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":P("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.cc||P("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().ac:b=oe([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function Tl(a){this.sa=this.h=!1;this.potentialEsfErrorCounter=this.i=0;this.handleError=function(){};
this.ca=function(){};
this.now=Date.now;this.ia=!1;var b;this.hb=null!=(b=a.hb)?b:100;var c;this.gb=null!=(c=a.gb)?c:1;var d;this.eb=null!=(d=a.eb)?d:2592E6;var e;this.cb=null!=(e=a.cb)?e:12E4;var f;this.fb=null!=(f=a.fb)?f:5E3;var g;this.A=null!=(g=a.A)?g:void 0;this.xa=!!a.xa;var h;this.wa=null!=(h=a.wa)?h:.1;var k;this.Ca=null!=(k=a.Ca)?k:10;a.handleError&&(this.handleError=a.handleError);a.ca&&(this.ca=a.ca);a.ia&&(this.ia=a.ia);a.sa&&(this.sa=a.sa);this.B=a.B;this.J=a.J;this.D=a.D;this.F=a.F;this.R=a.R;this.Na=a.Na;
this.Ma=a.Ma;Ul(this)&&(!this.B||this.B("networkless_logging"))&&Vl(this)}
function Vl(a){Ul(a)&&!a.ia&&(a.h=!0,a.xa&&Math.random()<=a.wa&&a.D.ob(a.A),Wl(a),a.F.I()&&a.ma(),a.F.X(a.Na,a.ma.bind(a)),a.F.X(a.Ma,a.Qa.bind(a)))}
...
p.ma=function(){var a=this;if(!Ul(this))throw xj("throttleSend");this.i||(this.i=this.J.L(function(){var b;return x(function(c){if(1==c.h)return w(c,a.D.Ua("NEW",a.A),2);if(3!=c.h)return b=c.i,b?w(c,Xl(a,b),3):(a.Qa(),c.return());a.i&&(a.i=0,a.ma());c.h=0})},this.hb))};
p.Qa=function(){this.J.Z(this.i);this.i=0};
function Xl(a,b){var c,d;return x(function(e){switch(e.h){case 1:if(!Ul(a))throw c=xj("immediateSend"),c;if(void 0===b.id){e.s(2);break}return w(e,a.D.Bb(b.id,a.A),3);case 3:(d=e.i)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(Zl(a,b,a.eb)){e.s(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.s(5);break}return w(e,a.D.aa(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=$l(a,b));if(!b){e.s(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.h){case 1:g=am(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Ca)){l.s(2);break}if(!a.F.Ea){l.s(3);break}return w(l,a.F.Ea(),3);case 3:if(a.F.I()){l.s(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.s(6);break}return w(l,a.D.Oa(b.id,a.A,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.Ca)return l.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){l.s(8);break}return b.sendCount<a.gb?w(l,a.D.Oa(b.id,a.A),12):w(l,a.D.aa(b.id,a.A),8);case 12:a.J.L(function(){a.F.I()&&a.ma()},a.fb);
case 8:c(e,f),l.h=0}})};
...
;var nm={},om=ql("ServiceWorkerLogsDatabase",{da:(nm.SWHealthLog={ga:1},nm),Fa:!0,upgrade:function(a,b){b(1)&&Tj(Mj(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}),"swHealthNewRequest",["interface","timestamp"])},
...
p.Ea=function(a){a=Te(this.i,a);a.then(function(b){R("use_cfr_monitor")&&vm().requestComplete("generate_204",b)});
return a};
Z.prototype.sendNetworkCheckRequest=Z.prototype.Ea;Z.prototype.listen=Z.prototype.X;Z.prototype.enableErrorFlushing=Z.prototype.qb;Z.prototype.getWindowStatus=Z.prototype.tb;Z.prototype.networkStatusHint=Z.prototype.Y;Z.prototype.isNetworkAvailable=Z.prototype.I;Z.getInstance=zm;function Am(a){a=void 0===a?{}:a;Pe.call(this);var b=this;this.i=this.u=0;this.l=zm();var c=C("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.Da?(this.Da=a.Da,c("networkstatus-online",function(){Bm(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Bm(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){Qe(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Qe(b,"publicytnetworkstatus-offline")})))}
...
Am.prototype.Ea=function(a){var b=this,c;return x(function(d){c=C("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.l);return R("skip_network_check_if_cfr")&&vm().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.Y((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.I())})):c?d.return(c(a)):d.return(!0)})};
function Bm(a,b){a.Da?a.i?(We.Z(a.u),a.u=We.L(function(){a.m!==b&&(Qe(a,b),a.m=b,a.i=U())},a.Da-(U()-a.i))):(Qe(a,b),a.m=b,a.i=U()):Qe(a,b)}
;var Cm;function Dm(){var a=Tl.call;Cm||(Cm=new Am({hc:!0,fc:!0}));a.call(Tl,this,{D:{ob:lm,aa:km,Ua:hm,Bb:im,Oa:jm,set:fm},F:Cm,handleError:$h,ca:ai,R:Em,now:U,ib:ym,J:$i(),Na:"publicytnetworkstatus-online",Ma:"publicytnetworkstatus-offline",xa:!0,wa:.1,Ca:wi("potential_esf_error_limit",10),B:R,ia:!(bj()&&"www.youtube-nocookie.com"!==Qb(document.location.toString()))});this.j=new Wf;R("networkless_immediately_drop_all_requests")&&mm();nl("LogsDatabaseV2")}
v(Dm,Tl);function Fm(){var a=C("yt.networklessRequestController.instance");a||(a=new Dm,B("yt.networklessRequestController.instance",a),R("networkless_logging")&&fl().then(function(b){a.A=b;Vl(a);a.j.resolve();a.xa&&Math.random()<=a.wa&&a.A&&qm(a.A);R("networkless_immediately_drop_sw_health_store")&&Gm(a)}));
return a}
...
c.onFetchSuccess=function(M,O){Ql(A);K(M,O)}}try{y&&d.retry&&!d.ab.bypassNetworkless?(g.method="POST",d.ab.writeThenSend?Fm().writeThenSend(q,g):Fm().sendAndWrite(q,g)):R("web_all_payloads_via_jspb")?Hi(q,g):(g.method="POST",g.postParams||(g.postParams={}),Hi(q,g))}catch(M){if("InvalidAccessError"==M.name)A&&(Ql(A),A=0),ai(Error("An extension is blocking network request."));
...
timeout:d.timeout,withCredentials:!0};g.headers["Content-Type"]||(g.headers["Content-Type"]="application/json");var h="";(f=a.config_.xb)&&(h=f);var k=a.config_.zb||!1,l=Ll(k,h,d);Object.assign(g.headers,l);(f=g.headers.Authorization)&&!h&&(g.headers["x-origin"]=window.location.origin);var m="/youtubei/"+a.config_.vb+"/"+b,n={alt:"json"},r=a.config_.yb&&f;r=r&&f.startsWith("Bearer");r||(n.key=a.config_.ub);var q=ti(""+h+m,n||{},!0);C("ytNetworklessLoggingInitializationOptions")&&Im.isNwlInitialized?
dl().then(function(y){e(y)}):e(!1)}
;var Km=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function Lm(a){this.H=a;this.h=null;this.m=0;this.C=null;this.u=0;this.i=[];for(a=0;4>a;a++)this.i.push(0);this.l=0;this.Ga=ji(window,"mousemove",Va(this.Ha,this));this.Ia=li(Va(this.V,this),25)}
D(Lm,pe);Lm.prototype.Ha=function(a){void 0===a.h&&ei(a);var b=a.h;void 0===a.i&&ei(a);this.h=new Fd(b,a.i)};
...
Lm.prototype.ba=function(){window.clearInterval(this.Ia);hi(this.Ga)};var Mm={};
function Nm(){var a={},b=void 0===a.Cb?!1:a.Cb;a=void 0===a.rb?!0:a.rb;if(null==C("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;B("_lact",c,window);B("_fact",c,window);-1==c&&Om();ji(document,"keydown",Om);ji(document,"keyup",Om);ji(document,"mousedown",Om);ji(document,"mouseup",Om);b?ji(window,"touchmove",function(){Pm("touchmove",200)},{passive:!0}):(ji(window,"resize",function(){Pm("resize",200)}),a&&ji(window,"scroll",function(){Pm("scroll",200)}));
new Lm(function(){Pm("mouse",100)});
ji(document,"touchstart",Om,{passive:!0});ji(document,"touchend",Om,{passive:!0})}}
...
;var Rm=z.ytPubsubPubsubInstance||new N,Sm=z.ytPubsubPubsubSubscribedKeys||{},Tm=z.ytPubsubPubsubTopicToKeys||{},Um=z.ytPubsubPubsubIsSynchronous||{};N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.na;N.prototype.publish=N.prototype.ea;N.prototype.clear=N.prototype.clear;B("ytPubsubPubsubInstance",Rm);B("ytPubsubPubsubTopicToKeys",Tm);B("ytPubsubPubsubIsSynchronous",Um);B("ytPubsubPubsubSubscribedKeys",Sm);var Vm=Symbol("injectionDeps");function Wm(){this.i=new Map;this.h=new Map}
Wm.prototype.resolve=function(a){return Xm(this,a,[])};
function Xm(a,b,c){var d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.h.has(b))return a.h.get(b);if(!a.i.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.i.get(b);c.push(b);if(d.Jb)var e=d.Jb;else if(d.Ib)e=d[Vm]?Ym(a,d[Vm],c):[],e=d.Ib.apply(d,ia(e));else if(d.Hb){e=d.Hb;var f=e[Vm]?Ym(a,e[Vm],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ia(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.mc||a.h.set(b,e);return e}
...
;var dn=wi("initial_gel_batch_timeout",2E3),en=Math.pow(2,16)-1,fn=void 0;function gn(){this.j=this.h=this.i=0}
...
function sn(a,b){R("web_all_payloads_via_jspb")&&ai(new aj("transport.log called for JSON in JSPB only experiment"));if("log_event"===a.endpoint){tn(a);var c=un(a);if(R("use_new_in_memory_storage")){qn[c]=!0;var d={cttAuthInfo:c,isJspb:!1};rn().storePayload(d,a.payload);vn(b,[],c,!1,d)}else d=mn.get(c)||[],mn.set(c,d),d.push(a.payload),vn(b,d,c)}}
function wn(a,b){if("log_event"===a.endpoint){tn(void 0,a);var c=un(a,!0);if(R("use_new_in_memory_storage")){qn[c]=!0;var d={cttAuthInfo:c,isJspb:!0};rn().storePayload(d,a.payload.toJSON());vn(b,[],c,!0,d)}else d=nn.get(c)||[],nn.set(c,d),a=a.payload.toJSON(),d.push(a),vn(b,d,c,!0)}}
function vn(a,b,c,d,e){d=void 0===d?!1:d;a&&(fn=new a);a=wi("tvhtml5_logging_max_batch_ads_fork")||wi("tvhtml5_logging_max_batch")||wi("web_logging_max_batch")||100;var f=U(),g=d?jn.j:hn.j;b=b.length;e&&(b=rn().getSequenceCount(e));b>=a?kn||(kn=xn(function(){yn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d);kn=void 0},0)):10<=f-g&&(zn(d),d?jn.j=f:hn.j=f)}
function An(a,b){R("web_all_payloads_via_jspb")&&ai(new aj("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){tn(a);var c=un(a),d=new Map;d.set(c,[a.payload]);b&&(fn=new b);return new Xf(function(e,f){fn&&fn.isReady()?Bn(d,fn,e,f,{bypassNetworkless:!0},!0):e()})}}
function Cn(a,b){if("log_event"===a.endpoint){tn(void 0,a);var c=un(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(fn=new b);return new Xf(function(e){fn&&fn.isReady()?Dn(d,fn,e,{bypassNetworkless:!0},!0):e()})}}
function un(a,b){var c="";if(a.ha)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Mh;c.videoId?md(d,1,Nh,c.videoId):c.playlistId&&md(d,2,Nh,c.playlistId);pn[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),on[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function yn(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;!c&&R("web_all_payloads_via_jspb")&&ai(new aj("transport.flushLogs called for JSON in JSPB only experiment"));new Xf(function(d,e){c?(En(jn.i),En(jn.h),jn.h=0):(En(hn.i),En(hn.h),hn.h=0);if(fn&&fn.isReady())if(R("use_new_in_memory_storage")){var f=a,g=c,h=fn;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,l=new Map;if(void 0!==b)g?(e=rn().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),Dn(k,h,d,f)):(k=rn().extractMatchingEntries({isJspb:g,
...
function zn(a){a=void 0===a?!1:a;if(R("web_gel_timeout_cap")&&(!a&&!hn.h||a&&!jn.h)){var b=xn(function(){yn({writeThenSend:!0},void 0,a)},6E4);
a?jn.h=b:hn.h=b}En(a?jn.i:hn.i);b=P("LOGGING_BATCH_TIMEOUT",wi("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&ln&&(b=dn);b=xn(function(){yn({writeThenSend:!0},void 0,a)},b);
a?jn.i=b:hn.i=b}
function Bn(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(U()),h=a.size,k={};a=u(a);for(var l=a.next();!l.done;k={pa:k.pa,U:k.U,fa:k.fa,ra:k.ra,qa:k.qa},l=a.next()){var m=u(l.value);l=m.next().value;m=m.next().value;k.U=mb({context:Dl(b.config_||Cl())});if(!Oa(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.U.events=m;(m=on[l])&&Fn(k.U,l,m);delete on[l];k.fa="visitorOnlyApprovedKey"===l;Gn(k.U,g,k.fa);Hn(e);k.ra=function(n){R("update_log_event_config")&&We.L(function(){return x(function(r){return w(r,
In(n),0)})});
h--;h||c()};
k.pa=0;k.qa=function(n){return function(){n.pa++;if(e.bypassNetworkless&&1===n.pa)try{Sl(b,"log_event",n.U,Jn({writeThenSend:!0},n.fa,n.ra,n.qa,f)),ln=!1}catch(r){$h(r),d()}h--;h||c()}}(k);
try{Sl(b,"log_event",k.U,Jn(e,k.fa,k.ra,k.qa,f)),ln=!1}catch(n){$h(n),d()}}}
function Dn(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(U()),g=a.size,h=new Map([].concat(ia(a)));h=u(h);for(var k=h.next();!k.done;k=h.next()){var l=u(k.value).next().value,m=a.get(l);k=new Oh;var n=Kl(b.config_||Cl());J(k,sh,1,n);m=m?Kn(m):[];m=u(m);for(n=m.next();!n.done;n=m.next())td(k,3,Jh,n.value);(m=pn[l])&&Ln(k,l,m);delete pn[l];l="visitorOnlyApprovedKey"===l;Mn(k,f,l);Hn(d);k=Bd(k);l=Jn(d,l,function(r){R("update_log_event_config")&&We.L(function(){return x(function(q){return w(q,In(r),
0)})});
g--;g||c()},function(){g--;
g||c()},e);
l.headers["Content-Type"]="application/json+protobuf";l.postBodyFormat="JSPB";l.postBody=k;Sl(b,"log_event","",l);ln=!1}}
function Hn(a){R("always_send_and_write")&&(a.writeThenSend=!1)}
function Jn(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,ab:a,ha:b,ec:!!e,headers:{},postBodyFormat:"",postBody:""};Nn()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(U())));return a}
function Gn(a,b,c){Nn()||(a.requestTimeMs=String(b));R("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=P("EVENT_ID"))&&(c=On(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function Mn(a,b,c){Nn()||I(a,2,b);if(!c&&(b=P("EVENT_ID"))){c=On();var d=new Lh;I(d,1,b);I(d,2,c);J(a,Lh,5,d)}}
function On(){var a=P("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*en/2));a++;a>en&&(a=1);Uh("BATCH_CLIENT_COUNTER",a);return a}
...
function Ln(a,b,c){if(ud(c,1===nd(c,Nh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;J(a,Mh,4,c);a=od(a,sh,1)||new sh;c=od(a,qh,3)||new qh;var e=new ph;I(e,2,b);I(e,1,d);td(c,12,ph,e);J(a,qh,3,c)}
function Kn(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new Jh(a[c]))}catch(d){$h(new aj("Transport failed to deserialize "+String(a[c])))}return b}
...
function Nn(){return R("use_request_time_ms_header")||R("lr_use_request_time_ms_header")}
function xn(a,b){return R("transport_use_scheduler")?Wi(a,b):ki(a,b)}
function En(a){R("transport_use_scheduler")?We.Z(a):window.clearTimeout(a)}
...
function Qn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||U());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&Nm();a=Qm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.la&&(a=e.context,b=d.la,b={index:Rn(b),groupKey:b},a.sequence=b,d.sb&&delete Pn[d.la]);(d.Eb?An:sn)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ha:d.ha},c)}
function Sn(a){yn(void 0,void 0,void 0===a?!1:a)}
function Rn(a){Pn[a]=a in Pn?Pn[a]+1:0;return Pn[a]}
;var Tn=[];var Un=z.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",Un);function Vn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;P("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:Jm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||U());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Qm();d=new Ih;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.la){e=b.la;var f=Rn(e),g=new Hh;I(g,2,f);I(g,1,e);J(d,Hh,3,g);b.sb&&delete Un[b.la]}J(a,Ih,33,d);(b.Eb?Cn:wn)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,ha:b.ha},c)}
;function Wn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;c.timestamp=Math.round(c.timestamp||U());var d=Jm;P("ytLoggingEventsDefaultDisabled",!1)&&Jm===Jm&&(d=null);R("web_all_payloads_via_jspb")?Tn.push({kc:a,payload:b,options:c}):Qn(a,b,d,c)}else d=Jm,P("ytLoggingEventsDefaultDisabled",!1)&&Jm==Jm&&(d=null),Qn(a,b,d,c)}
;var Xn=[{La:function(a){return"Cannot read property '"+a.key+"'"},
...
Ba:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Zn={T:[],S:[{nb:Yn,weight:500}]};function Yn(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function $n(){this.S=[];this.T=[]}
var ao;function bo(){if(!ao){var a=ao=new $n;a.T.length=0;a.S.length=0;Zn.T&&a.T.push.apply(a.T,Zn.T);Zn.S&&a.S.push.apply(a.S,Zn.S)}return ao}
...
;function qo(){var a;return x(function(b){return(a=qf())?b.return(a.then(function(c){c=Bd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return wc(d,3)})):b.return(Promise.resolve(null))})}
...
function Bo(a,b,c){Co||(Co={},ji(window,"message",function(d){a:{if(d.origin===Ao(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Co[e.id])d.u=!0,d.u&&(E(d.m,d.sendMessage,d),d.m.length=0),d.Pa(e)}e=void 0}return e}));
Co[c]=b}
...
p.Pa=function(a){Io(this,a.event,a)};
...
p.destroy=function(){this.h&&this.h.id&&(to[this.h.id]=null);var a=this.l;a&&"function"==typeof a.dispose&&a.dispose();if(this.o){a=this.h;var b=a.parentNode;b&&b.replaceChild(this.o,a)}else(a=this.h)&&a.parentNode&&a.parentNode.removeChild(a);Co&&(Co[this.id]=null);this.i=null;a=this.h;for(var c in kb)kb[c][0]==a&&hi(c);this.o=this.h=null};
p.Sa=function(){return{}};
...
b.toString());var g=a.Sa();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&E(["debugjs","debugcss"],function(k){var l=Zb(window.location.href,k);null!==l&&(g[k]=l)});
...
function Go(a){Bo(a.i,a,a.id);a.j=li(a.bb.bind(a),250);ji(a.h,"load",function(){window.clearInterval(a.j);a.j=li(a.bb.bind(a),250)})}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=ko)){var m=void 0,n=void 0,r=f,q=g,y=Jd(r),A=y.message||"Unknown Error",H=y.name||"UnknownError",
K=y.stack||r.i||"Not available";if(K.startsWith(H+": "+A)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",pb=y.fileName||"Not available",uc=K,Aa=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var ra=0;ra<r.args.length&&!(Aa=go(r.args[ra],"params."+ra,q,Aa),500<=Aa);ra++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(n in X){if(X[n]){var ca="params."+n,da=io(X[n]);q[ca]=da;Aa+=ca.length+da.length;if(500<Aa)break}}else q.params=
io(X)}if(no.length)for(var W=0;W<no.length&&!(Aa=go(no[W],"params.context."+W,q,Aa),500<=Aa);W++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:A,name:H,lineNumber:O,fileName:pb,stack:uc,params:q,sampleWeight:1},bk=Number(r.columnNumber);isNaN(bk)||(S.lineNumber=S.lineNumber+":"+bk);if("IGNORED"===r.level)m=0;else a:{for(var ck=bo(),dk=u(ck.T),$f=dk.next();!$f.done;$f=dk.next()){var ek=$f.value;if(S.message&&S.message.match(ek.ic)){m=ek.weight;
break a}}for(var fk=u(ck.S),ag=fk.next();!ag.done;ag=fk.next()){var gk=ag.value;if(gk.nb(S)){m=gk.weight;break a}}m=1}S.sampleWeight=m;for(var hk=u(Xn),bg=hk.next();!bg.done;bg=hk.next()){var cg=bg.value;if(cg.Ba[S.name])for(var ik=u(cg.Ba[S.name]),dg=ik.next();!dg.done;dg=ik.next()){var jk=dg.value,Wd=S.message.match(jk.regexp);if(Wd){S.params["params.error.original"]=Wd[0];for(var eg=jk.groups,kk={},Vb=0;Vb<eg.length;Vb++)kk[eg[Vb]]=Wd[Vb+1],S.params["params.error."+eg[Vb]]=Wd[Vb+1];S.message=cg.La(kk);
break}}}S.params||(S.params={});var lk=bo();S.params["params.errorServiceSignature"]="msg="+lk.T.length+"&cb="+lk.S.length;S.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!jo.has(ua.message)){if("ERROR"===h){co.ea("handleError",
ua);if(R("record_app_crashed_web")&&0===mo&&1===ua.sampleWeight)if(mo++,R("errors_via_jspb")){var fg=new Gh;I(fg,1,1);if(!R("report_client_error_with_app_crash_ks")){var mk=new Bh;I(mk,1,ua.message);var nk=new Ch;J(nk,Bh,3,mk);var ok=new Dh;J(ok,Ch,5,nk);var pk=new Eh;J(pk,Dh,9,ok);J(fg,Eh,4,pk)}var Qo=fg,qk=new Jh;rd(qk,Gh,20,Kh,Qo);Vn(qk)}else{var rk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(rk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
Wn("appCrashed",rk)}lo++}else"WARNING"===h&&co.ea("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var gg=void 0,hg=void 0,Mc=h,Q=ua;if(R("errors_via_jspb")){if(po())hg=void 0;else{var Wb=new yh;I(Wb,1,Q.stack);Q.fileName&&I(Wb,4,Q.fileName);var Ma=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Ma.length&&(1!==Ma.length||isNaN(Number(Ma[0]))?2!==Ma.length||isNaN(Number(Ma[0]))||isNaN(Number(Ma[1]))||(I(Wb,2,Number(Ma[0])),I(Wb,3,Number(Ma[1]))):I(Wb,2,Number(Ma[0])));var vb=
new Bh;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Mc?I(vb,2,2):"WARNING"===Mc?I(vb,2,1):I(vb,2,0);var ig=new zh;I(ig,1,!0);rd(ig,yh,3,Ah,Wb);var wb=new vh;I(wb,3,window.location.href);for(var sk=P("FEXP_EXPERIMENTS",[]),jg=0;jg<sk.length;jg++){var tk=wb,Ro=sk[jg];Xc(tk);ld(tk,5,2,!1,!1).push(Ro)}var kg=Vh();if(!Wh()&&kg)for(var uk=u(Object.keys(kg)),xb=uk.next();!xb.done;xb=uk.next()){var vk=xb.value,lg=new xh;I(lg,1,vk);I(lg,2,String(kg[vk]));td(wb,4,xh,lg)}var mg=Q.params;
if(mg){var wk=u(Object.keys(mg));for(xb=wk.next();!xb.done;xb=wk.next()){var xk=xb.value,ng=new xh;I(ng,1,"client."+xk);I(ng,2,String(mg[xk]));td(wb,4,xh,ng)}}var yk=P("SERVER_NAME"),zk=P("SERVER_VERSION");if(yk&&zk){var og=new xh;I(og,1,"server.name");I(og,2,yk);td(wb,4,xh,og);var pg=new xh;I(pg,1,"server.version");I(pg,2,zk);td(wb,4,xh,pg)}var Xd=new Ch;J(Xd,vh,1,wb);J(Xd,zh,2,ig);J(Xd,Bh,3,vb);hg=Xd}var Ak=hg;if(!Ak)break a;var Bk=new Jh;rd(Bk,Ch,163,Kh,Ak);Vn(Bk)}else{if(po())gg=void 0;else{var Nc=
{stackTrace:Q.stack};Q.fileName&&(Nc.filename=Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(Nc.lineNumber=Number(Na[0]),Nc.columnNumber=Number(Na[1])):Nc.lineNumber=Number(Na[0]));var qg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Mc?qg.level="ERROR_LEVEL_ERROR":"WARNING"===Mc&&(qg.level="ERROR_LEVEL_WARNNING");
var So={isObfuscated:!0,browserStackInfo:Nc},Xb={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(Xb.experimentIds=P("FEXP_EXPERIMENTS"));var rg=Vh();if(!Wh()&&rg)for(var Ck=u(Object.keys(rg)),yb=Ck.next();!yb.done;yb=Ck.next()){var Dk=yb.value;Xb.kvPairs.push({key:Dk,value:String(rg[Dk])})}var sg=Q.params;if(sg){var Ek=u(Object.keys(sg));for(yb=Ek.next();!yb.done;yb=Ek.next()){var Fk=yb.value;Xb.kvPairs.push({key:"client."+Fk,value:String(sg[Fk])})}}var Gk=P("SERVER_NAME"),Hk=P("SERVER_VERSION");
Gk&&Hk&&(Xb.kvPairs.push({key:"server.name",value:Gk}),Xb.kvPairs.push({key:"server.version",value:Hk}));gg={errorMetadata:Xb,stackTrace:So,logMessage:qg}}var Ik=gg;if(!Ik)break a;Wn("clientError",Ik)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(Sn(!0),!R("web_fp_via_jspb_and_json")))break c;Sn()}else{if(R("web_fp_via_jspb")&&(Sn(!0),!R("web_fp_via_jspb_and_json")))break b;Sn()}}if(!R("suppress_error_204_logging")){var zb=ua,
...
vg=Lk.next();!vg.done;vg=Lk.next()){var Mk=vg.value;ab.postParams[Mk]=ug[Mk]}var Nk=P("SERVER_NAME"),Ok=P("SERVER_VERSION");Nk&&Ok&&(ab.postParams["server.name"]=Nk,ab.postParams["server.version"]=Ok)}Hi(P("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{jo.add(ua.message)}catch(Xo){}ko++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Lo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
v(No,Eo);p=No.prototype;p.Sa=function(){var a=Ao(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Ao(this.i,"embedConfig")){if(Pa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
p.Pa=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.O[c]=a[c]);break;case "infoDelivery":Oo(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.j),this.playerInfo={},this.O={},Po(this,a.apiInterface),Oo(this,a));break;default:Io(this,b,a)}};
